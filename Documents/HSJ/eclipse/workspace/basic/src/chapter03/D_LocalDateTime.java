...
public class D_LocalDateTime {
	...
	public static void main(String[] args) {
		...
		// Date를 String(문자열)으로 변경
		// SimpleDateFormat 클래스를 사용하여 지정한 문자열 포멧으로 변경
		SimpleDateFormat simpleDateFormat = new SimpleDateFormat();
		String stringDate = simpleDateFormat.format(localToDate);
		System.out.println(stringDate);
		
		// y : 연도, M : 월, d : 일, a : 오전오후, H : 시간(24시), h : 시간(12시), m : 분, s : 초, E : 요일
		// 오후 5:14 2025-01-06
		...
		// 오후 5:14:33 2025-01-06
		stringDate = now.format(DateTimeFormatter.ofPattern("a hh:mm:ss yyyy-mm-dd"));
		System.out.println(stringDate);
    }
}
